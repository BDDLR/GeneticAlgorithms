...
void gfx_Text(int x, int y, char* txt)
{
	XDrawString(gfx_display, gfx_window, gfx_gc, x, y, txt,(sizeof(txt)+1)/sizeof(char));

}

/*Write number in the window*/

void gfx_Number(int x, int y, char* txt)
{
	int aux = atoi(txt);
	if(aux <= 9){
		XDrawString(gfx_display, gfx_window, gfx_gc, x, y, txt,sizeof(txt)/sizeof(int)-1);
	}
	else if(aux <=99){
		XDrawString(gfx_display, gfx_window, gfx_gc, x, y, txt,sizeof(txt)/sizeof(int));
	}
	else{
		XDrawString(gfx_display, gfx_window, gfx_gc, x, y, txt,sizeof(txt)/sizeof(int)+1);
	}
